...
urlpatterns = [
    ...
    auth_view.PasswordResetDoneView.as_view(template_name='app/password_reset_done.html'), name='password_reset_done'),
...
admin.site.site_header = "FurniCraft"
admin.site.site_title = "FurniCraft"
admin.site.site_index_title = "Welcome To FurniCraft Store"